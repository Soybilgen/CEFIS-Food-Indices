...
st.markdown("You can download all our data as excel file <a href='https://github.com/Soybilgen/CEFIS-Food-Indices/output.xlsx'>here</a>.", unsafe_allow_html=True)
